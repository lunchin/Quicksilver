...
namespace EPiServer.Reference.Commerce.Site.Features.Recommendations.Services
{
    ...
    public class RecommendationService : IRecommendationService
    {
        ...
        public TrackingResponseData SendHomePageTracking(HttpContextBase httpContext)
        {
            var trackingData = _trackingDataFactory.CreateHomeTrackingData(httpContext);
            return _trackingService.Send(trackingData, httpContext);
        }

        public TrackingResponseData SendProductTracking(HttpContextBase httpContext, string code)
        {
            var trackingData = _trackingDataFactory.CreateProductTrackingData(code, httpContext);
            return _trackingService.Send(trackingData, httpContext);
        }
    }
}